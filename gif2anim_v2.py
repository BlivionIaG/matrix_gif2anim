...
def pack_anim(srcs, dst, dst_width, dst_height, anim):
    with open(dst, "wb") as f:
        ...
        d = struct.pack(ANIM_HDR, sig, hdr_size, offset, file_size, dst_width,dst_height,2,total)
...
if __name__ == "__main__":
    if (len(sys.argv) < 3):
        print("Usage: gif2anim in_file out_file <anim> | <auxi> | <amft>")
    else: 
        if sys.argv[3] not in ["anim", "auxi", "amft"]:
